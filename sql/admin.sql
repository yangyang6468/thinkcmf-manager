...
INSERT INTO `cmf_admin_menu` VALUES ('162', '0', '0', '1', '10000', 'admin', 'Article', 'default', '', '文章管理', '', '');
INSERT INTO `cmf_admin_menu` VALUES ('163', '162', '1', '1', '10000', 'admin', 'Article', 'index', '', '列表', '', '');
...
CREATE TABLE `cmf_articles` (
  ...
  `label` int(11) DEFAULT '0' COMMENT '分类',
  `title` varchar(100) DEFAULT NULL COMMENT '消息标题',
  `info` text COMMENT '消息内容',
  ...
  `praise_count` int(11) unsigned DEFAULT '0' COMMENT '点赞次数',
  ...
  `status` int(11) DEFAULT '0' COMMENT '审核状态：0未审核1已审核2驳回',
  `remark` varchar(100) DEFAULT NULL COMMENT '审核不通过的原因',
  `isdelete` int(11) DEFAULT '0' COMMENT '是否删除',
  `topicid` varchar(50) DEFAULT NULL COMMENT '话题id',
  `flag` int(2) DEFAULT '0' COMMENT '标识：0前台用户发表、1后台发表',
  `recommend` tinyint(4) DEFAULT '0' COMMENT '是否推荐：0否 1是',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='财经圈文章表';

-- ----------------------------
-- Records of cmf_articles
-- ----------------------------
INSERT INTO `cmf_articles` VALUES ('1530871027', '1530871027', '1', '2', '1265 Data truncated for column \'updatetime\' ', '&lt;p&gt;&lt;/p&gt;&lt;h1 style=&quot;margin: 10px 0px 0px; font-size: 28px; font-weight: 500; line-height: 32px; color: rgb(51, 51, 51); font-family: Consolas, &amp;quot;Liberation Mono&amp;quot;, Courier, Verdana, 微软雅黑; white-space: normal;&quot;&gt;1265 Data truncated for column &amp;#39;updatetime&amp;#39; at row 1&lt;/h1&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;&lt;h1 style=&quot;margin: 10px 0px 0px; font-size: 28px; font-weight: 500; line-height: 32px; color: rgb(51, 51, 51); font-family: Consolas, &amp;quot;Liberation Mono&amp;quot;, Courier, Verdana, 微软雅黑; white-space: normal;&quot;&gt;1265 Data truncated for column &amp;#39;updatetime&amp;#39; at row 1&lt;/h1&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', null, '0', '0', '0', '0', '0', '0', null, '0', null, '0', null, '0', '0', '0', '0', '0');
...
INSERT INTO `cmf_auth_rule` VALUES ('163', '1', 'admin', 'admin_url', 'admin/Article/index', '', '列表', '');
...
-- Records of cmf_user
-- ----------------------------
INSERT INTO `cmf_user` VALUES ('1', '1', '0', '0', '1530869946', '0', '0', '0.00', '1530501418', '1', 'admin', '###3b0cb953921789a5d42f998e1c9f6a48', 'admin', 'admin@163.com', '', '', '', '127.0.0.1', '', '', null);
...
CREATE TABLE `cmf_userinfos` (
  ...
  `fromsource` int(11) DEFAULT NULL COMMENT '用户来源',
  ...
  `weixin` varchar(30) DEFAULT NULL COMMENT '用户微信',
  `sina` varchar(30) DEFAULT NULL COMMENT '用户微博',
  `usertype` int(11) DEFAULT '1' COMMENT '用户类型',
  `gradeid` int(11) DEFAULT '1' COMMENT '等级id',
  `expervalue` int(11) DEFAULT '0' COMMENT '经验值',
  `gender` int(11) DEFAULT '1',
  `roomid` int(11) NOT NULL DEFAULT '0' COMMENT '房间id',
  `isdelete` int(11) DEFAULT '0' COMMENT '是否删除',
  `signature` varchar(255) DEFAULT NULL COMMENT '个性签名',
  `issign` int(11) DEFAULT '0',
  `signcount` int(11) DEFAULT '0' COMMENT '累计签到的天数',
  `usergrade` int(11) DEFAULT '0',
  `lastsigndate` date DEFAULT NULL,
  `focusnumbymy` int(11) DEFAULT '0' COMMENT '我的关注',
  `focusnum` int(11) DEFAULT '0' COMMENT '我的粉丝',
